...
public:
	...
	std::vector<std::string> get_headerBuf_by_val() { return headerBuf_; }
	std::vector<std::string> get_stringColBuf_by_val() { return stringColBuf_; }
	std::vector<double> get_calcResultBuf_by_val() { return calcResultBuf_; }
	*/
