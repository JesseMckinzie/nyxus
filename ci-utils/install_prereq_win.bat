...
set BOOST_INCLUDEDIR=local_install/boost_1_79_0/include
set BOOST_LIBRARYDIR=local_install/boost_1_79_0/lib64-msvc-14.3
set BOOST_ROOT=local_install/boost_1_79_0/boost
