...
mkdir build
pushd build
cmake .. -G "Visual Studio 17 2022" -A x64 -DCMAKE_INSTALL_PREFIX=../../../local_install/ -DCMAKE_PREFIX_PATH=../../../local_install/ -DARROW_PARQUET=ON -DARROW_WITH_SNAPPY=ON -DBOOST_ROOT="%_ROOTDIR%/local_install/boost_1_79_0" -DBoost_INCLUDE_DIR="%_ROOTDIR%/local_install/include/boost"
